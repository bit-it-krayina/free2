 ...
 */
class UserPrivate extends \CsnUser\Entity\Info\UserPrivate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'birthDay', 'location', '' . "\0" . 'CsnUser\\Entity\\Info\\UserPrivate' . "\0" . 'resume');
        }
