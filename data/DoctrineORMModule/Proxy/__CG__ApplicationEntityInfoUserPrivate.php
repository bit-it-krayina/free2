...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Info;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UserPrivate extends \Application\Entity\Info\UserPrivate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'birthDay', 'location', '' . "\0" . 'Application\\Entity\\Info\\UserPrivate' . "\0" . 'resume');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserPrivate $proxy) {
